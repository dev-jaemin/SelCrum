...
--
-- Host: localhost    Database: selcrumdb
-- ------------------------------------------------------
...
CREATE TABLE `projects` (
  ...
  `last_check` date DEFAULT (curdate()),
...
CREATE TABLE `task_sprint` (
  ...
  CONSTRAINT `task_sprint_ibfk_1` FOREIGN KEY (`task_id`) REFERENCES `tasks` (`task_id`),
  CONSTRAINT `task_sprint_ibfk_2` FOREIGN KEY (`sprint_id`) REFERENCES `sprints` (`sprint_id`)
...
CREATE TABLE `user_project` (
  ...
  KEY `user_id` (`user_id`),
  KEY `project_id` (`project_id`),
  CONSTRAINT `user_project_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`),
  CONSTRAINT `user_project_ibfk_2` FOREIGN KEY (`project_id`) REFERENCES `projects` (`project_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-10-11 10:50:44
